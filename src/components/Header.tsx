...
const Header = () => {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-blue-600 shadow-lg border-b border-blue-700 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-lg font-bold text-white">Plantilla</span>
          </div>

          <div className="hidden md:block ml-6">
            <Breadcrumb>
              <BreadcrumbList>
                {breadcrumbs.map((crumb, index) => <BreadcrumbItem key={crumb.href}>
                    {crumb.current ? <BreadcrumbPage className="text-blue-100">
                        {crumb.label}
                      </BreadcrumbPage> : <>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <Button variant="ghost" size="sm" onClick={logout} className="text-blue-200 hover:text-white hover:bg-red-500/20">
